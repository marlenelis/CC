...
int main() {
  ...
  banco.Ingreso(ncuenta1,hora1,fecha1,2000,"Primera imposicin");
  banco.Ingreso(ncuenta1,hora2,fecha1,1000,"Mi primer sueldo");
  banco.Ingreso(ncuenta2,hora3,fecha2,10000,"Primera imposicin");
  ...
  banco.Retirada(ncuenta2,hora7,fecha6,2500,"Vmonos de compras");
  banco.Ingreso(ncuenta2,hora8,fecha7,5700,"Me ha tocado la lotera");
